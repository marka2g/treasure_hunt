...
class GamesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create game" do
    assert_difference("Game.count") do
      post games_url, params: { game: { board_size: @game.board_size, current_position: @game.current_position, treasure_x: @game.treasure_x, treasure_y: @game.treasure_y, user_id: @game.user_id, winning_distance: @game.winning_distance } }
    end
