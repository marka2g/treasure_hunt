...
class MovesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create move" do
    assert_difference("Move.count") do
      post moves_url, params: { move: { game_id: @move.game_id, winner: @move.winner, x: @move.x, y: @move.y } }
    end
  ...
  test "should update move" do
    patch move_url(@move), params: { move: { game_id: @move.game_id, winner: @move.winner, x: @move.x, y: @move.y } }
